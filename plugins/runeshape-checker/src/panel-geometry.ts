...
/** Calibrated fixed fallback for standard ~8-row item pages when layout peaks fail. */
export const FIXED_LIST_TOP_IN_PANEL = 0.123
export const FIXED_LIST_BOTTOM_IN_PANEL = 0.566

/** Item rewards ("1x Orb…") — left of rune icons. */
export const ITEM_TEXT_LEFT_IN_PANEL = 0.34
export const ITEM_TEXT_RIGHT_IN_PANEL = 0.58

/** Grand Expedition skills/supports — right-aligned label column. */
export const SKILL_TEXT_LEFT_IN_PANEL = 0.58
export const SKILL_TEXT_RIGHT_IN_PANEL = 0.99

/** Each skill entry is two visual rows (rune icons, then label). */
export const SKILL_ENTRY_STRIDE = 2
export const SKILL_TEXT_Y_PHASE = 0.52

export interface RowBandOptions {
  /** Multiply calibrated row height (2 = icon row + label row). */
  stride?: number
  /** Vertical offset within each stride as a fraction of stride height. */
  yPhaseFrac?: number
}

/** @deprecated use ITEM_TEXT_LEFT_IN_PANEL */
export const TEXT_LEFT_IN_PANEL = ITEM_TEXT_LEFT_IN_PANEL
/** @deprecated use ITEM_TEXT_RIGHT_IN_PANEL */
