...
3. # to Level of all Minion Skills`
  ...
  it('normalizes mod lines for stat matching', () => {
    expect(normalizeGuideModLine('Adds # to # Fire damage to Attacks')).toBe('Adds # to # Fire Damage to Attacks')
  ...
  it('extracts armour and accessory priority lines', () => {
    ...
    expect(parseGuideStatLines('1. #% to all Elemental Resistances')).toEqual(['#% to all Elemental Resistances'])
  })
