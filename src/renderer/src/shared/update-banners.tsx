...
export function UpdateAvailableBanner({
  ...
  return (
    <div className="relative flex flex-col gap-1 px-3.5 py-2 text-[11px] overflow-hidden shrink-0 bg-[rgba(255,183,77,0.24)]">
      {(progress !== null || ready) && (
        <div
      ...
      {installError && (
        <span className="text-[#ef5350] font-semibold relative z-[1]">
