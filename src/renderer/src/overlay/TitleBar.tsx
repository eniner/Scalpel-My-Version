import { Setting, CloseSmall, ChartHistogram, Flask, Buy, AllApplication, Filter, Ranking } from '@icon-park/react'
...
export function TitleBar({
  ...
  return (
    <div
      className="flex items-center gap-2 px-3.5 py-2.5 border-b border-border cursor-grab"
    ...
    >
      ...
      {/* Scrollable tool tabs — settings/close stay pinned so they never clip off. */}
      <div className="flex gap-1.5 items-center min-w-0 flex-1 overflow-x-auto no-scrollbar justify-end">
