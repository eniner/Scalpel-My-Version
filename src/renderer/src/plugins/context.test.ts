...
const baseDeps = () => ({
  ...
  filter: {
    getSections: vi.fn(async () => ({ ok: true, sections: [] })),
    getBlock: vi.fn(async () => ({ ok: false })),
    setTierVisibility: vi.fn(async () => ({ ok: false })),
    saveBlockEdit: vi.fn(async () => ({ ok: false })),
    addBaseTypeToTier: vi.fn(async () => ({ ok: false })),
    removeBaseTypeFromTier: vi.fn(async () => ({ ok: false })),
    moveItemTier: vi.fn(async () => ({ ok: false })),
    batchMoveItemTier: vi.fn(async () => ({ ok: false })),
    previewBaseTypeMove: vi.fn(async () => ({})),
    deleteFilterBlock: vi.fn(async () => ({ ok: false })),
    moveFilterBlock: vi.fn(async () => ({ ok: false })),
    insertSectionRule: vi.fn(async () => ({ ok: false })),
    applySectionDelta: vi.fn(async () => ({})),
    matchItem: vi.fn(async () => ({})),
    parseItemText: vi.fn(async () => ({})),
    getLastEvaluatedItem: vi.fn(async () => ({})),
    getRecentEvaluatedItems: vi.fn(async () => []),
    simulateLootDrops: vi.fn(async () => ({})),
    preflight: vi.fn(async () => ({})),
    findConditions: vi.fn(async () => ({ ok: true, hits: [] })),
    getHistory: vi.fn(async () => []),
    undoEdit: vi.fn(async () => ({ ok: false })),
    undoToEntry: vi.fn(async () => ({ ok: false })),
    undoSectionHistory: vi.fn(async () => ({ ok: false, undone: 0 })),
    listVersions: vi.fn(async () => []),
    createCheckpoint: vi.fn(async () => ({ ok: false })),
    restoreVersion: vi.fn(async () => ({ ok: false })),
    deleteVersion: vi.fn(async () => ({ ok: false })),
    diffFilterFiles: vi.fn(async () => ({})),
    diffFilterVsVersion: vi.fn(async () => ({})),
    previewReapply: vi.fn(async () => ({})),
    applyReapply: vi.fn(async () => ({})),
    exportIntents: vi.fn(async () => ({})),
    importIntents: vi.fn(async () => ({})),
    getChanges: vi.fn(async () => []),
    reload: vi.fn(async () => ({ ok: false })),
    getSearchableItems: vi.fn(async () => []),
    getIconCache: vi.fn(async () => ({})),
    onIconCacheUpdated: vi.fn(() => () => {}),
    getSettings: vi.fn(async () => ({})),
    listProfiles: vi.fn(async () => []),
    scanFilterDir: vi.fn(async () => []),
    detectActiveGameFilter: vi.fn(async () => ({})),
    scanSoundFiles: vi.fn(async () => []),
    getSoundDataUrl: vi.fn(async () => null),
    batchLookupPrices: vi.fn(async () => ({})),
    onChanged: vi.fn(() => () => {}),
    onZoneChanged: vi.fn(() => () => {}),
    filterBladeUrl: vi.fn(async () => null),
  },
  webPanel: {
