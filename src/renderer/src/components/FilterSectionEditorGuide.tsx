      ...
      case 'overview':
        return (
          <>
            ...
            <p style={p}>
              Edits write to your <strong style={{ color: '#f0e6d2' }}>local filter file</strong> and can reload in-game.
              This editor does <strong style={{ color: '#f0e6d2' }}>not</strong> switch your active in-game filter to an
              OnlineFilters Strictness copy (that was a common footgun and was removed).
            </p>
            <div style={callout}>
        ...
        return (
          <>
            ...
            <ol style={{ ...ul, listStyle: 'decimal' }}>
              <li>Open Settings → Filter → <strong style={{ color: '#f0e6d2' }}>Open large editor</strong>.</li>
              <li>Pick a group (e.g. Currency), then a section from the dropdown.</li>
              <li>
                Switch to <strong style={{ color: '#f0e6d2' }}>Edit</strong>. Expand a tier, drag items between tiers, or
                multi-select and bump with Arrow keys.
              </li>
              <li>
                Use the <strong style={{ color: '#f0e6d2' }}>section sticky bar</strong> for Hide ≤C, Sort by price, Undo
                section, Checkpoint, and Style.
              </li>
              <li>
                When something looks wrong in-game, go <strong style={{ color: '#f0e6d2' }}>Advanced</strong> → Workflow{' '}
                <em>Diagnose</em> → paste or “From game” → <em>Make this win</em> if needed → <em>Verify</em> with the loot
                suite.
              </li>
            </ol>
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 12 }}>
              ...
              {onGoAdvanced && (
                <button type="button" onClick={onGoAdvanced} style={{ fontSize: 12, minHeight: 32, padding: '6px 12px' }}>
                  Go to Advanced
                </button>
              )}
            </div>
      ...
      case 'modes':
        return (
          <>
            ...
            <p style={p}>
              Power tools behind a short <strong style={{ color: '#f0e6d2' }}>Workflow</strong> (Diagnose → Fix → Verify).
              Everything else lives under <strong style={{ color: '#f0e6d2' }}>More tools</strong> so the toolbar stays
              readable.
            </p>
            <h3 style={h3}>Guide</h3>
            <p style={p}>This help tab. Press <K>?</K> anytime for the keyboard shortcut overlay.</p>
          </>
        )
      case 'editing':
        return (
          <>
            ...
            <ul style={ul}>
              ...
              <li>Multi-select with click, then use the bump pills or <K>↑</K>/<K>↓</K>.</li>
            ...
            <ul style={ul}>
              ...
              <li>
                Style opens colors, font, beams, built-in/custom sounds, and a visual minimap picker.
              </li>
        ...
        return (
          <>
            ...
            <ul style={ul}>
              ...
              <li>Find (More tools) searches StackSize / missing MinimapIcon / etc., scoped to the section if you want.</li>
              <li>
