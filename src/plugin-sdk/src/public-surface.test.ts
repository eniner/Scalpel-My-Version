...
function stubDeps(): PluginContextFactoryDeps {
  ...
  const stubCraft = {
    ...
    searchBases: async () => [],
    listItemClasses: async () => [],
    searchMods: async () => [],
  } as unknown as PluginContextFactoryDeps['craft']
  return {
    ...
    trade: {
      ...
      scanWarrants: async () => ({
        ...
        wantSkills: [],
        skillMatchMode: 'any',
        resolvedSkillFilters: 0,
        wantSupports: [],
        supportPresenceMode: 'any',
        supportLinkOrder: 'ignore',
        linkSkill: null,
        resolvedSupportFilters: 0,
        excludedLinkMismatches: 0,
        groups: [],
        listings: [],
        webSearchUrl: '',
      }),
