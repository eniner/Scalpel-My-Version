...
export const POE2_OMENS: OmenDef[] = [
  ...
  { id: 'homogenising_coronation', name: 'Homogenising Coronation', desc: 'Regal adds a mod matching existing mod types.' },
  ...
  { id: 'homogenising_exaltation', name: 'Homogenising Exaltation', desc: 'Exalt adds a mod matching existing mod types.' },
  ...
  { id: 'sinistral_crystallisation', name: 'Sinistral Crystallisation', desc: 'Perfect essence removes only a prefix.' },
