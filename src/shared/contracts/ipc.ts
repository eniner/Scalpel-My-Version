...
export const IPC_CHANNELS = {
  ...
  FILTERS: {
    ...
    CREATE_SCALPEL: 'create-scalpel-filter',
    REFRESH_SCALPEL: 'refresh-scalpel-filter',
    GET_ORIGIN: 'get-filter-origin',
    SWITCH_INGAME: 'switch-ingame-filter',
    GET_COLOR_FREQUENCIES: 'get-color-frequencies',
    GET_CUSTOM_TIERS: 'get-custom-tiers',
    SAVE_CUSTOM_TIER: 'save-custom-tier',
    DELETE_CUSTOM_TIER: 'delete-custom-tier',
    ADD_CUSTOM_TIER_ITEM: 'add-custom-tier-item',
    REMOVE_CUSTOM_TIER_ITEM: 'remove-custom-tier-item',
  ...
  PLUGINS: {
    ...
    TRADE_PRICE_CHECK: 'plugins:trade-price-check',
    TRADE_SCAN_LISTINGS: 'plugins:trade-scan-listings',
